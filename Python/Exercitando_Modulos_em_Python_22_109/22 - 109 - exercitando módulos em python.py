...
#107
from Exercitando_Modulos_em_Python_22_109 import moeda
...
#109
print(f'\nO Dobro de {moeda.moeda(valor)} é: {moeda.dobro(valor, True)}')
print(f'A Metade de {moeda.moeda(valor)} é: {moeda.metade(valor, True)}')
print(f'O valor {moeda.moeda(valor)} com mais {a}% de aumento é: {moeda.aumentar(valor, a, True)}')
print(f'O valor {moeda.moeda(valor)} com menos {d}% de desconto é: {moeda.diminuir(valor, d, True)}')
